...
export const Header = () => {
	...
	return (
		<header className="border-b bg-[#1c1c1c] py-10 dark:border-neutral-800 dark:bg-neutral-900">
			<Container className="grid grid-cols-4 gap-5 px-5">
				...
				<div className="col-span-2 flex flex-row items-center justify-end gap-5 text-slate-300 lg:col-span-3">
					...
					<Button href={domain + '/buy'} as="a" type="quicksilicon-button" label="Buy our courses" />
				</div>
			</Container>
